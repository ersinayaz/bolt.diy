...
const appointment = async (appointmentDate) => {
    ...
    const appointmentHours = appointmentHours();
    ...
    const response = await request("appointment-post", `AppointmentCustomers/Appointment?lang=tr&smsCode=${config.appointmentOTP}&paymentCustomerId=${data.id}`);
    return response;
}